    ...
    SEMICOLON.initialize = {
        init: function () {
            ...
            return e().appear ? void(t.length > 0 && t.each(function () {
                ...
                t.attr("src", "http://canvashtml-cdn.semicolonweb.com/images/blank.svg").css({background: "url(http://canvashtml-cdn.semicolonweb.com/images/preloader.gif) no-repeat center center #FFF"}), t.appear(function () {
