...
!function (e) {
    ...
    var t = jQuery.fn.revolution, a = (t.is_mobile(), t.is_android(), {
    ...
    jQuery.extend(!0, t, {
        updateMarkup: function (e, i) {
            ...
            if (void 0 !== t.start && !t.frames_added && void 0 === t.frames) {
                var a = new Array, o = _(c(), t.transform_in, void 0, !1), r = _(c(), t.transform_out, void 0, !1),
            ...
            var a = e.data(), o = a.videotype, r = a.autoplay, n = a.autoplayonlyfirsttime;
            ...
            var t = parseInt(e.data("startslide"), 0), a = parseInt(e.data("endslide"), 0);
            ...
            var i = e.opt, o = e.slide, r = e.recall, n = e.maintimeline, s = e.preset, d = e.startslideanimat,
            ...
            void 0 !== i.rowzones && (p = p > i.rowzones.length ? i.rowzones.length : p), void 0 != i.rowzones && i.rowzones.length > 0 && void 0 != i.rowzones[p] && p >= 0 && p <= i.rowzones.length && i.rowzones[p].length > 0 && t.setSize(i), s || void 0 !== d && (void 0 !== m && jQuery.each(i.timelines[m].layers, function (e, a) {
                ...
                var o = a.layer.data(), r = p >= a.firstslide && p <= a.lastslide,
                    n = p < a.firstslide || p > a.lastslide, s = a.timeline.getLabelTime("slide_" + a.firstslide),
                    d = a.timeline.getLabelTime("slide_" + a.lastslide), l = o.static_layer_timeline_time,
                    m = "in" === o.animdirection || "out" !== o.animdirection && void 0,
                    c = "bytrigger" === o.frames[0].delay,
                    g = (o.frames[o.frames.length - 1].delay, o.triggered_startstatus), f = o.lasttriggerstate;
            ...
            var a = e.caption, o = a.data(), r = e.opt, n = e.recall, s = e.recall,
            ...
            if (o._pw = void 0 === o._pw ? a.closest(".tp-parallax-wrap") : o._pw, o._lw = void 0 === o._lw ? a.closest(".tp-loop-wrap") : o._lw, o._mw = void 0 === o._mw ? a.closest(".tp-mask-wrap") : o._mw, o._responsive = o.responsive || "on", o._respoffset = o.responsive_offset || "on", o._ba = o.basealign || "grid", o._gw = "grid" === o._ba ? r.width : r.ulw, o._gh = "grid" === o._ba ? r.height : r.ulh, o._lig = void 0 === o._lig ? a.hasClass("rev_layer_in_group") ? a.closest(".rev_group") : a.hasClass("rev_layer_in_column") ? a.closest(".rev_column_inner") : a.hasClass("rev_column_inner") ? a.closest(".rev_row") : "none" : o._lig, o._column = void 0 === o._column ? a.hasClass("rev_column_inner") ? a.closest(".rev_column") : "none" : o._column, o._row = void 0 === o._row ? a.hasClass("rev_column_inner") ? a.closest(".rev_row") : "none" : o._row, o._ingroup = void 0 === o._ingroup ? !(a.hasClass("rev_group") || !a.closest(".rev_group")) : o._ingroup, o._isgroup = void 0 === o._isgroup ? !!a.hasClass("rev_group") : o._isgroup, o._nctype = o.type || "none", o._cbgc_auto = void 0 === o._cbgc_auto ? "column" === o._nctype && o._pw.find(".rev_column_bg_auto_sized") : o._cbgc_auto, o._cbgc_man = void 0 === o._cbgc_man ? "column" === o._nctype && o._pw.find(".rev_column_bg_man_sized") : o._cbgc_man, o._slideid = o._slideid || a.closest(".tp-revslider-slidesli").data("index"), o._id = void 0 === o._id ? a.data("id") || a.attr("id") : o._id, o._slidelink = void 0 === o._slidelink ? void 0 !== a.hasClass("slidelink") && a.hasClass("slidelink") : o._slidelink, void 0 === o._li && (a.hasClass("tp-static-layer") ? (o._isstatic = !0, o._li = a.closest(".tp-static-layers"), o._slideid = "staticlayers") : o._li = a.closest(".tp-revslider-slidesli")), o._row = void 0 === o._row ? "column" === o._nctype && o._pw.closest(".rev_row") : o._row, void 0 === o._togglelisteners && a.find(".rs-toggled-content") ? (o._togglelisteners = !0, void 0 === o.actions && a.click(function () {
                ...
                a.closest("li").find(".helpgrid").css({top: e.offsety + "px", left: e.offsetx + "px"});
            ...
            if ("off" === (void 0 === o.visibility ? "oon" : y(o.visibility, r)[r.forcedWinRange] || y(o.visibility, r) || "ooon") || o._gw < r.hideCaptionAtLimit && "on" == o.captionhidden || o._gw < r.hideAllCaptionAtLimit ? o._pw.addClass("tp-hidden-caption") : o._pw.removeClass("tp-hidden-caption"), o.layertype = "html", e.offsetx < 0 && (e.offsetx = 0), void 0 != o.thumbimage && void 0 == o.videoposter && (o.videoposter = o.thumbimage), a.find("img").length > 0) {
                w = a.find("img");
                o.layertype = "image", 0 == w.width() && w.css({width: "auto"}), 0 == w.height() && w.css({height: "auto"}), void 0 == w.data("ww") && w.width() > 0 && w.data("ww", w.width()), void 0 == w.data("hh") && w.height() > 0 && w.data("hh", w.height());
                var m = w.data("ww"), c = w.data("hh"), p = "slide" == o._ba ? r.ulw : r.gridwidth[r.curWinRange],
                ...
                var f = "full" === m || "full-proportional" === m, h = "full" === c || "full-proportional" === c;
                if ("full-proportional" === m) {
                    var u = w.data("owidth"), v = w.data("oheight");
                ...
                m = void 0 === m ? 0 : m, c = void 0 === c ? 0 : c, "off" !== o._responsive ? ("grid" != o._ba && f ? jQuery.isNumeric(m) ? w.css({width: m + "px"}) : w.css({width: m}) : jQuery.isNumeric(m) ? w.css({width: m * r.bw + "px"}) : w.css({width: m}), "grid" != o._ba && h ? jQuery.isNumeric(c) ? w.css({height: c + "px"}) : w.css({height: c}) : jQuery.isNumeric(c) ? w.css({height: c * r.bh + "px"}) : w.css({height: c})) : w.css({
                    width: m,
                    height: c
                }), o._ingroup && "row" !== o._nctype && (void 0 !== m && !jQuery.isNumeric(m) && "string" === jQuery.type(m) && m.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], {minWidth: m}), void 0 !== c && !jQuery.isNumeric(c) && "string" === jQuery.type(c) && c.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], {minHeight: c}))
            }
            if ("slide" === o._ba) e.offsetx = 0, e.offsety = 0; else if (o._isstatic && void 0 !== r.carousel && void 0 !== r.carousel.horizontal_align && "carousel" === r.sliderType) {
            ...
            if (a.hasClass("tp-videolayer") || a.hasClass("tp-audiolayer") || a.find("iframe").length > 0 || a.find(_).length > 0) {
                ...
                var w = a.find("iframe") ? a.find("iframe") : w = a.find(_), k = !a.find("iframe"),
                    L = a.hasClass("coverscreenvideo");
                w.css({display: "block"}), void 0 == a.data("videowidth") && (a.data("videowidth", w.width()), a.data("videoheight", w.height()));
                ...
                if ("auto" == I.lineHeight && (I.lineHeight = I.fontSize + 4), a.hasClass("fullscreenvideo") || L) {
                    ...
                    var W = o._gh;
                    "on" == r.autoHeight && (W = r.conh), a.css({width: o._gw, height: W})
                ...
                (0 == k && !L || 1 != o.forcecover && !a.hasClass("fullscreenvideo") && !L) && (w.width(m), w.height(c)), o._ingroup && null !== o.videowidth && void 0 !== o.videowidth && !jQuery.isNumeric(o.videowidth) && o.videowidth.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], {minWidth: o.videowidth})
            }
            j(a, r, 0, o._responsive), a.hasClass("tp-resizeme") && a.find("*").each(function () {
                j(jQuery(this), r, "rekursive", o._responsive)
            });
            var R = a.outerHeight(), C = a.css("backgroundColor");
            ...
            var z = 0 == o.arrobj.voa.length ? 0 : o.arrobj.voa, O = 0 == o.arrobj.hoa.length ? 0 : o.arrobj.hoa,
                Q = 0 == o.arrobj.elx.length ? 0 : o.arrobj.elx, S = 0 == o.arrobj.ely.length ? 0 : o.arrobj.ely;
            ...
            if ("row" !== o._nctype && "column" !== o._nctype) punchgs.TweenLite.set(o._pw, {
                ...
                punchgs.TweenLite.set(o._pw, {zIndex: F, width: X, top: 0, left: e.offsetx, overwrite: "auto"})
            }
            if (void 0 !== o.blendmode && punchgs.TweenLite.set(o._pw, {mixBlendMode: o.blendmode}), "row" === o._nctype && (o.columnbreak <= r.curWinRange ? a.addClass("rev_break_columns") : a.removeClass("rev_break_columns")), "on" == o.loopanimation && punchgs.TweenLite.set(o._lw, {
                    minWidth: o.eow,
                    minHeight: o.eoh
                }), "column" === o._nctype) {
                var Y = void 0 !== a[0]._gsTransform ? a[0]._gsTransform.y : 0,
                    H = parseInt(o._column[0].style.paddingTop, 0);
                punchgs.TweenLite.set(a, {y: 0}), punchgs.TweenLite.set(o._cbgc_man, {y: parseInt(H + o._column.offset().top - a.offset().top, 0)}), punchgs.TweenLite.set(a, {y: Y})
            }
            o._ingroup && "row" !== o._nctype && (void 0 !== o._groupw && !jQuery.isNumeric(o._groupw) && o._groupw.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], {minWidth: o._groupw}), void 0 !== o._grouph && !jQuery.isNumeric(o._grouph) && o._grouph.indexOf("%") > 0 && punchgs.TweenLite.set([o._lw, o._pw, o._mw], {minHeight: o._grouph}))
        }, createTimelineStructure: function (e) {
            function i(e, i, t, a) {
                var o, r = new punchgs.TimelineLite({paused: !0});
            ...
            e.timelines = e.timelines || new Object, e.c.find(".tp-revslider-slidesli, .tp-static-layers").each(function () {
                var t = jQuery(this), a = t.data("index");
            ...
            var i, a, o = e.caption, r = o.data(), n = e.opt, d = {}, l = h();
            if (!(i = n.timelines[r._slideid].layers[r._id]).generated || !0 === e.regenerate) {
                if (a = i.timeline, i.generated = !0, void 0 !== r.current_timeline && !0 !== e.regenerate ? (r.current_timeline_pause = r.current_timeline.paused(), r.current_timeline_time = r.current_timeline.time(), r.current_is_nc_timeline = a === r.current_timeline, r.static_layer_timeline_time = r.current_timeline_time) : (r.static_layer_timeline_time = r.current_timeline_time, r.current_timeline_time = 0, r.current_timeline && r.current_timeline.clear()), a.clear(), d.svg = void 0 != r.svg_src && o.find("svg"), d.svg && (r.idlesvg = g(r.svg_idle, p()), punchgs.TweenLite.set(d.svg, r.idlesvg.anim)), -1 !== r.hoverframeindex && void 0 !== r.hoverframeindex && !o.hasClass("rs-hover-ready")) {
                    ...
                    o.hover(function (e) {
                        var i = {
                            ...
                            firstframe: "frame_0",
                            lastframe: "frame_999"
                        }, t = (s(i), i.caption), a = t.data(), o = a.frames[a.hoverframeindex];
                ...
                for (var c = 0; c < r.frames.length; c++) if (c !== r.hoverframeindex) {
                    var f = c === r.inframeindex ? "frame_0" : c === r.outframeindex || "frame_999" === r.frames[c].frame ? "frame_999" : "frame_" + c;
                    r.frames[c].framename = f, i[f] = {}, i[f].timeline = new punchgs.TimelineLite({align: "normal"});
            ...
            var i = e.caption, t = i.data(), a = e.label, s = e.timeline, d = e.frameindex, p = e.opt, g = i, h = {},
                u = p.timelines[t._slideid].layers[t._id], y = t.frames.length - 1, w = t.frames[d].split,
                x = t.frames[d].split_direction, T = t.frames[d].sfx_effect, k = !1;
            if (x = void 0 === x ? "forward" : x, -1 !== t.hoverframeindex && t.hoverframeindex == y && (y -= 1), h.content = new punchgs.TimelineLite({align: "normal"}), h.mask = new punchgs.TimelineLite({align: "normal"}), void 0 === s.vars.id && (s.vars.id = Math.round(1e5 * Math.random())), "column" === t._nctype && (s.add(punchgs.TweenLite.set(t._cbgc_man, {visibility: "visible"}), a), s.add(punchgs.TweenLite.set(t._cbgc_auto, {visibility: "hidden"}), a)), t.splittext && 0 === d) {
            ...
            var L, I,
                W = d !== t.outframeindex ? _(c(), t.frames[d].to, void 0, k, g.length - 1) : void 0 !== t.frames[d].to && null === t.frames[d].to.match(/auto:auto/g) ? _(f(), t.frames[d].to, 1 == p.sdir, k, g.length - 1) : _(f(), t.frames[t.inframeindex].from, 0 == p.sdir, k, g.length - 1),
            ...
            if (0 === d && !e.fromcurrentstate && void 0 !== t._bmask && void 0 !== T && T.indexOf("block") >= 0 || d === t.outframeindex && !e.fromcurrentstate && void 0 !== t._bmask && void 0 !== T && T.indexOf("block") >= 0) {
                var Q = 0 === d ? R.speed / 1e3 / 2 : W.speed / 1e3 / 2,
                    ...
                    M = {scaleY: 1, scaleX: 0, transformOrigin: "100% 50%", ease: W.anim.ease};
                switch (O = void 0 === C ? Q : C + Q, T) {
                    ...
                    case"blockfromtop":
                    case"blocktobottom":
                        S = [{scaleX: 1, scaleY: 0, transformOrigin: "50% 0%"}, {
                            scaleX: 1,
                            scaleY: 1,
                            ease: W.anim.ease
                        }], M = {scaleX: 1, scaleY: 0, transformOrigin: "50% 100%", ease: W.anim.ease};
                        break;
                    case"blocktotop":
                    case"blockfrombottom":
                        S = [{scaleX: 1, scaleY: 0, transformOrigin: "50% 100%"}, {
                            scaleX: 1,
                            scaleY: 1,
                            ease: W.anim.ease
                        }], M = {scaleX: 1, scaleY: 0, transformOrigin: "50% 0%", ease: W.anim.ease}
                }
            ...
            if (0 !== d || e.fromcurrentstate) if ("block" === t._sfx_out && d === t.outframeindex) s.add(h.content.staggerTo(g, .001, {
                autoAlpha: 0,
                delay: O
            }), a), s.add(h.content.staggerTo(g, W.speed / 1e3 / 2 - .001, {
                x: 0,
                delay: O
            }), a + "+=0.001"); else if (k && void 0 !== P) {
                F = {to: m(W.anim)};
                for (var A in g) {
            ...
            } else void 0 !== t.frames[d].color && (W.anim.color = t.frames[d].color), void 0 !== t.frames[d].bgcolor && (W.anim.backgroundColor = t.frames[d].bgcolor), s.add(h.content.staggerTo(g, W.speed / 1e3, W.anim, C), a); else if ("block" === t._sfx_in) s.add(h.content.staggerFromTo(g, .05, {
                x: 0,
                y: 0,
                autoAlpha: 0
            }, {x: 0, y: 0, autoAlpha: 1, delay: O}), a); else if (k && void 0 !== P) {
                var F = {from: m(R.anim), to: m(W.anim)};
                for (var A in g) {
                    var X = jQuery.extend({}, R.anim), Y = jQuery.extend({}, W.anim);
            ...
            return void 0 === I || !1 === I || 0 === d && e.ignorefirstframe || (I.anim.ease = void 0 === I.anim.ease || "inherit" === I.anim.ease ? t.frames[0].ease : I.anim.ease, I.anim.overflow = "hidden", I.anim.x = I.anim.x * p.bw || v(I.anim.x, p, t.eow, t.eoh, t.calcy, t.calcx, "horizontal"), I.anim.y = I.anim.y * p.bw || v(I.anim.y, p, t.eow, t.eoh, t.calcy, t.calcx, "vertical")), 0 === d && L && !1 !== L && !e.fromcurrentstate || 0 === d && e.ignorefirstframe ? ((I = new Object).anim = new Object, I.anim.overwrite = "auto", I.anim.ease = W.anim.ease, I.anim.x = I.anim.y = 0, L && !1 !== L && (L.anim.x = L.anim.x * p.bw || v(L.anim.x, p, t.eow, t.eoh, t.calcy, t.calcx, "horizontal"), L.anim.y = L.anim.y * p.bw || v(L.anim.y, p, t.eow, t.eoh, t.calcy, t.calcx, "vertical"), L.anim.overflow = "hidden")) : 0 === d && s.add(h.mask.set(t._mw, {overflow: "visible"}), a), void 0 !== L && void 0 !== I && !1 !== L && !1 !== I ? s.add(h.mask.fromTo(t._mw, R.speed / 1e3, L.anim, I.anim, C), a) : void 0 !== I && !1 !== I && s.add(h.mask.to(t._mw, W.speed / 1e3, I.anim, C), a), s.addLabel(a + "_end"), t._gsTransformTo && d === y && t.hoveredstatus && (t.hovertimelines.item = punchgs.TweenLite.to(i, 0, t._gsTransformTo)), t._gsTransformTo = !1, h.content.eventCallback("onStart", o, [d, u, t._pw, t, s, W.anim, i, e.updateStaticTimeline, p]), h.content.eventCallback("onUpdate", r, [a, t._id, t._pw, t, s, d, jQuery.extend(!0, {}, W.anim), e.updateStaticTimeline, i, p]), h.content.eventCallback("onComplete", n, [d, t.frames.length, y, t._pw, t, s, e.updateStaticTimeline, i, p]), s
        }, endMoveCaption: function (e) {
            e.firstframe = "frame_0", e.lastframe = "frame_999";
            var i = s(e), a = e.caption.data();
            if (void 0 !== e.frame ? i.timeline.play(e.frame) : (!i.static || e.currentslide >= i.removeonslide || e.currentslide < i.showonslide) && (i.outnow = new punchgs.TimelineLite, i.timeline.pause(), !0 === a.visibleelement && t.createFrameOnTimeline({
                    ...
                    opt: e.opt,
                    fromcurrentstate: !0
                }).play()), e.checkchildrens && i.timeline_obj && i.timeline_obj.dchildren && "none" !== i.timeline_obj.dchildren && i.timeline_obj.dchildren.length > 0) for (var o = 0; o < i.timeline_obj.dchildren.length; o++) t.endMoveCaption({
            ...
            var i, a = s(e), o = e.caption.data(), r = 0;
            ...
            if ("stop" === t.compare_version(a).check) return !1;
            var o = e.data("index"), r = new Array;
    ...
    var o = function (e, i, a, o, r, n, s, d, l) {
        ...
        switch (i) {
            ...
            case"backward":
                ...
                break;
            case"middletoedge":
                var a = Math.ceil(e / 2), o = a - 1, r = a + 1;
                t.push(a);
        ...
        var i = {};
        for (var t in e) "string" == typeof e[t] && e[t].indexOf("|") >= 0 && (void 0 === i[t] && (i[t] = {index: 0}), i[t].values = e[t].replace("[", "").replace("]", "").split("|"), i[t].len = i[t].values.length - 1);
        return i
    }, c = function (e) {
        ...
        if (e.split("{").length > 1) {
            var r = e.split(","), n = parseFloat(r[1].split("}")[0]);
        ...
        var r = T(o.cssobj, i), n = i.bw, s = i.bh;
        ...
        if ("column" === o._nctype && (punchgs.TweenLite.set(o._column, {
            ...
            if (e.css("-webkit-transition", "none"), e.css("-moz-transition", "none"), e.css("-ms-transition", "none"), e.css("transition", "none"), (void 0 !== e.data("transform_hover") || void 0 !== e.data("style_hover")) && punchgs.TweenLite.set(e, r.styleProps), punchgs.TweenLite.set(e, {
                ...
                var l = "slide" == r.basealign ? i.ulw : i.gridwidth[i.curWinRange],
                    m = "slide" == r.basealign ? i.ulh : i.gridheight[i.curWinRange], c = k(r.maxWidth, n, "none", l),
                    p = k(r.maxHeight, s, "none", m), g = k(r.minWidth, n, "0px", l), f = k(r.minHeight, s, "0px", m);
                if (g = void 0 === g ? 0 : g, f = void 0 === f ? 0 : f, c = void 0 === c ? "none" : c, p = void 0 === p ? "none" : p, o._isgroup && ("#1/1#" === g && (g = c = l), "#1/2#" === g && (g = c = l / 2), "#1/3#" === g && (g = c = l / 3), "#1/4#" === g && (g = c = l / 4), "#1/5#" === g && (g = c = l / 5), "#1/6#" === g && (g = c = l / 6), "#2/3#" === g && (g = c = l / 3 * 2), "#3/4#" === g && (g = c = l / 4 * 3), "#2/5#" === g && (g = c = l / 5 * 2), "#3/5#" === g && (g = c = l / 5 * 3), "#4/5#" === g && (g = c = l / 5 * 4), "#3/6#" === g && (g = c = l / 6 * 3), "#4/6#" === g && (g = c = l / 6 * 4), "#5/6#" === g && (g = c = l / 6 * 5)), o._ingroup && (o._groupw = g, o._grouph = f), punchgs.TweenLite.set(e, {
                    ...
                    0 != h && (punchgs.TweenLite.set(e.find("svg"), {
                        fill: h,
                        overwrite: "auto"
                    }), punchgs.TweenLite.set(e.find("svg path"), {fill: h, overwrite: "auto"}))
                }
            }
        ...
        if (e.hasClass("rs-pendulum") && void 0 == t._loop_timeline) {
            ...
            a *= i, o *= i, t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {
                ...
                rotation: a,
                transformOrigin: n
            }, {rotation: o, ease: s})), t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {
                force3D: "auto",
                rotation: o,
                transformOrigin: n
            }, {
        ...
        if (e.hasClass("rs-rotate") && void 0 == t._loop_timeline) {
            ...
            a *= i, o *= i, t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {
                ...
                rotation: o, ease: s, onComplete: function () {
                    t._loop_timeline.restart()
                }
            }))
        }
        if (e.hasClass("rs-slideloop") && void 0 == t._loop_timeline) {
            t._loop_timeline = new punchgs.TimelineLite;
            var d = void 0 == e.data("xs") ? 0 : e.data("xs"), l = void 0 == e.data("ys") ? 0 : e.data("ys"),
                m = void 0 == e.data("xe") ? 0 : e.data("xe"), c = void 0 == e.data("ye") ? 0 : e.data("ye"),
                r = void 0 == e.data("speed") ? 2 : e.data("speed"),
                s = void 0 == e.data("easing") ? punchgs.Power2.easeInOut : e.data("easing");
            d *= i, l *= i, m *= i, c *= i, t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {
                ...
                x: d,
                y: l
            }, {x: m, y: c, ease: s})), t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {
                force3D: "auto",
                x: m,
                y: c
            }, {
        ...
        if (e.hasClass("rs-pulse") && void 0 == t._loop_timeline) {
            ...
            var p = void 0 == e.data("zoomstart") ? 0 : e.data("zoomstart"),
                ...
                r = void 0 == e.data("speed") ? 2 : e.data("speed"),
                s = void 0 == e.data("easing") ? punchgs.Power2.easeInOut : e.data("easing");
            t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {force3D: "auto", scale: p}, {
                scale: g,
                ease: s
            })), t._loop_timeline.append(new punchgs.TweenLite.fromTo(e, r, {force3D: "auto", scale: g}, {
                scale: p,
                onComplete: function () {
                    t._loop_timeline.restart()
                }
        ...
        if (e.hasClass("rs-wave") && void 0 == t._loop_timeline) {
            ...
            var f = void 0 == e.data("angle") ? 10 : parseInt(e.data("angle"), 0),
                ...
                u = (n = void 0 == e.data("origin") ? "50% 50%" : e.data("origin")).split(" "), v = new Object;
            ...
            }, b = parseInt(f, 0), y = new punchgs.TweenLite.fromTo(_, r, {a: 0 + b}, {
                a: 360 + b,
                force3D: "auto",
                ease: punchgs.Linear.easeNone
            });
            y.eventCallback("onUpdate", function (e) {
                var i = e.a * (Math.PI / 180), t = e.yoffset + e.unit * (1 - Math.sin(i)),
                    a = e.xoffset + Math.cos(i) * e.unit;
                punchgs.TweenLite.to(e.element, .1, {force3D: "auto", x: a, y: t})
