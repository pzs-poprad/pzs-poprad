...
!function (e) {
    ...
    var a = jQuery.fn.revolution, i = a.is_mobile(), o = (a.is_android(), {
        alias: "Video Min JS",
        ...
        preLoadAudio: function (e, t) {
            ...
            switch (n.videotype) {
                ...
                case"html5":
                    ...
                    var p = "html5" == n.audio ? "audio" : "video", v = e.find(p), c = v[0];
                    ...
                    ("mute" == n.volume || a.lastToggleState(e.videomutetoggledby) || !0 === o.globalmute) && (c.muted = !0)
            }
            ...
            switch (t.leaveViewPortBasedStop || (t.lastplayedvideos = []), t.leaveViewPortBasedStop = !1, a.videotype) {
                ...
                case"vimeo":
                    ...
                    break;
                case"html5":
                    var o = "html5" == a.audio ? "audio" : "video", d = e.find(o), r = d[0];
            ...
            switch (o.videotype) {
                case"youtube":
                    if (0 == e.find("iframe").length) e.append(e.data("videomarkup")), s(e, i, !0); else if (void 0 != o.player.playVideo) {
                        var r = t(e.data("videostartat")), n = o.player.getCurrentTime();
            ...
            if (void 0 === t.data("vimeoid") || void 0 !== t.data("vimeoplayerloaded")) {
                ...
                var o = e.conw / e.conh, d = o / i.vd * 100, r = i.vd / o * 100;
            ...
            if ((void 0 != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && (t.vimeoapineeded = !0), (void 0 != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && 0 == a.addedvim) {
                ...
                var r = document.createElement("script"), o = document.getElementsByTagName("script")[0], d = !0;
            ...
            if ("stop" === a.compare_version(o).check) return !1;
            var u = e.data(), v = u.videoattributes, c = u.ytid, m = u.vimeoid,
                g = "auto" === u.videopreload || "canplay" === u.videopreload || "canplaythrough" === u.videopreload || "progress" === u.videopreload ? "auto" : u.videopreload,
                y = u.videomp4, f = u.videowebm, h = u.videoogv, b = u.allowfullscreenvideo, w = u.videocontrols,
                T = "http", k = "loop" == u.videoloop ? "loop" : "loopandnoslidestop" == u.videoloop ? "loop" : "",
            ...
            switch (k = !0 === u.nextslideatend ? "" : k, u.videotype = x, L) {
                ...
                case"youtube":
                    ...
                    var _ = t(e.data("videostartat")), S = t(e.data("videoendat"));
                    -1 != _ && (v = v + "&start=" + _), -1 != S && (v = v + "&end=" + S);
                    var j = v.split("origin=" + T + "://"), A = "";
    ...
    var d = function (e, t, a) {
        ...
        var s = e.data(), p = e.find("iframe"), m = "iframe" + Math.round(1e5 * Math.random() + 1), g = s.videoloop,
        ...
        if (g = "loop" == g || "loopandnoslidestop" == g, n(o, e), p.attr("id", m), d && e.data("startvideonow", !0), 1 !== e.data("videolistenerexist")) switch (s.videotype) {
                ...
                C = new YT.Player(m, {
                    events: {
                        onStateChange: function (i) {
                            var d = e.closest(".tp-simpleresponsive"), n = (s.videorate, e.data("videostart"), u());
                            if (i.data == YT.PlayerState.PLAYING) punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                                ...
                                display: "block",
                                ease: punchgs.Power3.easeInOut
                            }), "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? C.mute() : (C.unMute(), C.setVolume(parseInt(e.data("volume"), 0) || 75)), o.videoplaying = !0, v(e, o), y ? o.c.trigger("stoptimer") : o.videoplaying = !1, o.c.trigger("revolution.slide.onvideoplay", r(C, "youtube", e.data())), a.toggleState(s.videotoggledby); else {
                                if (0 == i.data && g) {
                                    var p = t(e.data("videostartat"));
                                    -1 != p && C.seekTo(p), C.playVideo(), a.toggleState(s.videotoggledby)
                                }
                            ...
                            var d, r = a.is_mobile(), n = e.hasClass("tp-videolayer");
                            if (r || a.isSafari11()) {
            ...
            case"vimeo":
                ...
                var k = a.is_mobile(), x = k || a.isSafari11(), V = e.hasClass("rs-background-video-layer");
                ...
                L.on("loaded", function (t) {
                    ...
                    if (e.data("currenttime", a.seconds), 0 != i && Math.abs(i - a.seconds) < 1 && i > a.seconds && 1 != e.data("nextslidecalled")) if (g) {
                        L.play();
        ...
        if (i && 1 == e.data("disablevideoonmobile")) return !1;
        var s = e.data(), p = "html5" == s.audio ? "audio" : "video", m = e.find(p), g = m[0], y = m.parent(),
            f = s.videoloop, h = "loopandnoslidestop" != f;
        ...
        var w = e.find(".tp-vid-play-pause")[0], T = e.find(".tp-vid-mute")[0], k = e.find(".tp-vid-full-screen")[0],
            x = e.find(".tp-seek-bar")[0], V = e.find(".tp-volume-bar")[0];
        void 0 != w && d(w, "click", function () {
            ...
            if (void 0 != x && (x.value = a), 0 != i && -1 != i && Math.abs(i - d) <= .3 && i > d && 1 != e.data("nextslidecalled")) if (f) {
                g.play();
