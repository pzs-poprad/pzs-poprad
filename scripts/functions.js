...
!function (e) {
    ...
    SEMICOLON.initialize = {
        init: function () {
            ...
            var e = jRespond([{label: "smallest", enter: 0, exit: 575}, {
                label: "handheld",
                enter: 576,
                exit: 767
            ...
            return i || (i = 450), "true" != e && (a.hasClass("device-sm") || a.hasClass("device-xs")) ? !0 : void(t.scrollTop() > Number(i) ? (V.fadeIn(), a.addClass("gototop-active")) : (V.fadeOut(), a.removeClass("gototop-active")))
        }, fullScreen: function () {
            Q.length > 0 && Q.each(function () {
                ...
                if ("slider" == i.attr("id")) {
                    ...
                    if (e("#slider.with-header").next("#header:not(.transparent-header)").length > 0 && (a.hasClass("device-xl") || a.hasClass("device-lg"))) {
                        var u = s.outerHeight();
                        n -= u
                    }
                }
            ...
            if (G.length > 0) if (a.hasClass("device-md") || a.hasClass("device-lg") || a.hasClass("device-xl")) {
                var t = 0;
                G.each(function () {
            ...
            return e().fitVids ? void e("#content,#footer,.slider-element:not(.revslider-wrap),.landing-offer-media,.portfolio-ajax-modal,.mega-menu-column").fitVids({
            ...
            var t = a.attr("data-animation-in"), s = a.attr("data-animation-out"), n = a.attr("data-speed-in"),
                o = a.attr("data-speed-out"), r = !1, l = a.attr("data-loader-timeout"), d = a.attr("data-loader"),
                c = a.attr("data-loader-color"), u = a.attr("data-loader-html"), f = "", h = "", m = "", p = "", g = "",
                v = "";
            t || (t = "fadeIn"), s || (s = "fadeOut"), n || (n = 1500), o || (o = 800), u || (u = '<div class="css3-spinner-bounce1"></div><div class="css3-spinner-bounce2"></div><div class="css3-spinner-bounce3"></div>'), l ? (r = !0, l = Number(l)) : (r = !1, l = !1), c && ("theme" == c ? (m = " bgcolor", p = " border-color", g = ' class="bgcolor"', v = ' class="border-color"') : (f = ' style="background-color:' + c + ';"', h = ' style="border-color:' + c + ';"'), u = '<div class="css3-spinner-bounce1' + m + '"' + f + '></div><div class="css3-spinner-bounce2' + m + '"' + f + '></div><div class="css3-spinner-bounce3' + m + '"' + f + "></div>"), "2" == d ? u = '<div class="css3-spinner-flipper' + m + '"' + f + "></div>" : "3" == d ? u = '<div class="css3-spinner-double-bounce1' + m + '"' + f + '></div><div class="css3-spinner-double-bounce2' + m + '"' + f + "></div>" : "4" == d ? u = '<div class="css3-spinner-rect1' + m + '"' + f + '></div><div class="css3-spinner-rect2' + m + '"' + f + '></div><div class="css3-spinner-rect3' + m + '"' + f + '></div><div class="css3-spinner-rect4' + m + '"' + f + '></div><div class="css3-spinner-rect5' + m + '"' + f + "></div>" : "5" == d ? u = '<div class="css3-spinner-cube1' + m + '"' + f + '></div><div class="css3-spinner-cube2' + m + '"' + f + "></div>" : "6" == d ? u = '<div class="css3-spinner-scaler' + m + '"' + f + "></div>" : "7" == d ? u = '<div class="css3-spinner-grid-pulse"><div' + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div></div>" : "8" == d ? u = '<div class="css3-spinner-clip-rotate"><div' + v + h + "></div></div>" : "9" == d ? u = '<div class="css3-spinner-ball-rotate"><div' + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div></div>" : "10" == d ? u = '<div class="css3-spinner-zig-zag"><div' + g + f + "></div><div" + g + f + "></div></div>" : "11" == d ? u = '<div class="css3-spinner-triangle-path"><div' + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div></div>" : "12" == d ? u = '<div class="css3-spinner-ball-scale-multiple"><div' + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div></div>" : "13" == d ? u = '<div class="css3-spinner-ball-pulse-sync"><div' + g + f + "></div><div" + g + f + "></div><div" + g + f + "></div></div>" : "14" == d && (u = '<div class="css3-spinner-scale-ripple"><div' + v + h + "></div><div" + v + h + "></div><div" + v + h + "></div></div>"), i.animsition({
                inClass: t,
                outClass: s,
                inDuration: Number(n),
            ...
            return e().appear ? void(t.length > 0 && t.each(function () {
                ...
                t.attr("src", "styles/images/blank.svg").css({background: "url(styles/images/preloader.gif) no-repeat center center #FFF"}), t.appear(function () {
                    t.css({background: "none"}).removeAttr("width").removeAttr("height").attr("src", a)
                }, {accX: 0, accY: 120}, "easeInCubic")
            })) : (console.log("lazyLoad: Appear not Defined."), !0)
        }, topScrollOffset: function () {
            var e = 0;
            return !a.hasClass("device-xl") && !a.hasClass("device-lg") || SEMICOLON.isMobile.any() ? e = 40 : (e = s.hasClass("sticky-header") ? w.hasClass("dots-menu") ? 100 : 144 : w.hasClass("dots-menu") ? 140 : 184, w.length || (e = s.hasClass("sticky-header") ? 100 : 140)), e
        }, defineColumns: function (e) {
            var t = 4, i = e.attr("data-xl-col"), s = e.attr("data-lg-col"), n = e.attr("data-md-col"),
                o = e.attr("data-sm-col"), r = e.attr("data-xs-col");
            ...
            if (t.css({width: ""}), t.hasClass("portfolio-full")) {
                var i = SEMICOLON.initialize.defineColumns(t), s = t.width(), n = Math.floor(s / i);
                if (a.hasClass("device-xs")) var o = 1; else var o = 0;
                ...
                s == l && (s = 1.005 * l, t.css({width: s + "px"}));
                var n = s / i;
            ...
            var t = e("[data-class-xs]"), i = e("[data-class-sm]"), s = e("[data-class-md]"), n = e("[data-class-lg]"),
                o = e("[data-class-xl]");
            t.length > 0 && t.each(function () {
                ...
                var t = e(this), i = t.attr("data-class-xl"),
            ...
            var t = e("[data-height-xs]"), i = e("[data-height-sm]"), s = e("[data-height-md]"),
                n = e("[data-height-lg]"), o = e("[data-height-xl]");
            t.length > 0 && t.each(function () {
                ...
                var t = e(this), i = t.attr("data-height-xl");
        ...
        init: function () {
            ...
            e("#primary-menu ul li:has(ul)").addClass("sub-menu"), e(".top-links ul li:has(ul) > a, #primary-menu.with-arrows > ul > li:has(ul) > a > div, #primary-menu.with-arrows > div > ul > li:has(ul) > a > div, #page-menu nav ul li:has(ul) > a > div").append('<i class="icon-angle-down"></i>'), e(".top-links > ul").addClass("clearfix"), (a.hasClass("device-xl") || a.hasClass("device-lg")) && (e("#primary-menu.sub-title > ul > li").hover(function () {
                ...
                e(this).prev().css({backgroundImage: 'url("styles/css/images/icons/menu-divider.png")'})
            }), e("#primary-menu.sub-title").children("ul").children(".current").prev().css({backgroundImage: "none"})), e("#primary-menu.on-click li:has(ul) > a").on("click", function (t) {
            ...
            s.hasClass("sticky-header") && (e("body:not(.side-header) #header:not(.no-sticky)").removeClass("sticky-header"), s.removeClass().addClass(d), n.removeClass().addClass(c), n.hasClass("force-not-dark") || n.removeClass("not-dark"), SEMICOLON.slider.swiperSliderMenu(), SEMICOLON.slider.revolutionSliderMenu()), s.hasClass("responsive-sticky-header") && e("body.sticky-responsive-menu #header").removeClass("responsive-sticky-header"), (a.hasClass("device-sm") || a.hasClass("device-xs") || a.hasClass("device-md")) && "undefined" == typeof f && (s.removeClass().addClass(d), n.removeClass().addClass(c), n.hasClass("force-not-dark") || n.removeClass("not-dark"))
        }, sideHeader: function () {
            ...
            if (N.length > 0) {
                var t = N.attr("data-speed"), i = N.attr("data-offset"), s = N.attr("data-easing");
            ...
            return a.hasClass("side-header") && (s = 0), J.each(function (a) {
                var n = e(this).offset().top, o = t.scrollTop(), r = s + x;
                o + r >= n && o < n + e(this).height() && e(this).attr("id") != i && (i = e(this).attr("id"))
            }), i
        }, logo: function () {
            !s.hasClass("dark") && !a.hasClass("dark") || n.hasClass("not-dark") ? (p && h.find("img").attr("src", p), g && m.find("img").attr("src", g)) : (v && h.find("img").attr("src", v), C && m.find("img").attr("src", C)), s.hasClass("sticky-header") && (O && h.find("img").attr("src", O), b && m.find("img").attr("src", b)), (a.hasClass("device-sm") || a.hasClass("device-xs")) && (y && h.find("img").attr("src", y), S && m.find("img").attr("src", S))
            ...
            q.length > 0 && (a.hasClass("device-lg") || a.hasClass("device-xl") ? (q.show(), q.find("a").css({width: 40}), q.find(".ts-text").each(function () {
                ...
                e(this).css({width: 40})
            })) : (q.show(), q.find("a").css({width: 40}), q.find("a").each(function () {
            ...
            e(document).on("click", function (t) {
                e(t.target).closest("#top-search").length || a.toggleClass("top-search-open", !1), e(t.target).closest("#top-cart").length || R.toggleClass("top-cart-open", !1), e(t.target).closest("#page-menu").length || w.toggleClass("pagemenu-active", !1), e(t.target).closest("#side-panel").length || a.toggleClass("side-panel-open", !1), e(t.target).closest("#primary-menu").length || e("#primary-menu.on-click > ul").find(".d-block").removeClass("d-block"), e(t.target).closest("#primary-menu.mobile-menu-off-canvas > ul").length || e("#primary-menu.mobile-menu-off-canvas > ul").toggleClass("d-block", !1), e(t.target).closest("#primary-menu.mobile-menu-off-canvas > div > ul").length || e("#primary-menu.mobile-menu-off-canvas > div > ul").toggleClass("d-block", !1)
            }), e("#top-search-trigger").click(function (t) {
                a.toggleClass("top-search-open"), R.toggleClass("top-cart-open", !1), e("#primary-menu > ul, #primary-menu > div > ul").toggleClass("d-block", !1), w.toggleClass("pagemenu-active", !1), a.hasClass("top-search-open") && A.find("input").focus(), t.stopPropagation(), t.preventDefault()
            })
        }, topcart: function () {
            e("#top-cart-trigger").click(function (e) {
                w.toggleClass("pagemenu-active", !1), R.toggleClass("top-cart-open"), e.stopPropagation(), e.preventDefault()
            })
        }
    }, SEMICOLON.slider = {
        init: function () {
            ...
            var t = L.filter(":not(.customjs)");
            t.each(function () {
                if (e(this).hasClass("swiper_wrapper")) {
                    var t = e(this).filter(".swiper_wrapper"), a = t.attr("data-direction"), i = t.attr("data-speed"),
                    ...
                    if (i || (i = 300), a || (a = "horizontal"), s = s ? Number(s) : 999999999, n = "true" == n ? !0 : !1, o || (o = "slide"), r = "false" == r ? !1 : !0, c = "false" == c ? !1 : !0, t.find(".swiper-pagination").length > 0) var u = t.find(".swiper-pagination"),
                        f = !0; else var u = "", f = !1;
                    var h = t.find(".slider-arrow-right"), m = t.find(".slider-arrow-left");
                    T = new Swiper(t.find(".swiper-parent"), {
                        ...
                        slidesPerView: 1,
                        grabCursor: r,
                        pagination: {el: u, paginationClickable: f},
            ...
            if ((a.hasClass("side-header") || s.hasClass("transparent-header")) && (t = 0), z.length > 0) {
                var i = z.outerHeight();
                e = i + t
            } else e = t;
            ...
            if (!a.hasClass("device-xl") && !a.hasClass("device-lg") || SEMICOLON.isMobile.any()) E.find(".slider-parallax-inner").length > 0 ? e(".slider-parallax-inner,.slider-parallax .slider-caption,.ei-title").css({transform: "translateY(0px)"}) : e(".slider-parallax,.slider-parallax .slider-caption,.ei-title").css({transform: "translateY(0px)"}); else {
            ...
            if (E.length > 0) if (!a.hasClass("device-xl") && !a.hasClass("device-lg") || SEMICOLON.isMobile.any()) E.find(".slider-arrow-left,.slider-arrow-right,.vertical-middle:not(.no-fade),.slider-caption,.ei-title,.camera_prev,.camera_next").css({opacity: 1}); else {
            ...
            L.find(".slider-caption:not(.custom-caption-pos)").each(function () {
                var t = e(this).outerHeight(), i = L.outerHeight();
            ...
            if (e = "undefined" != typeof e ? e : !1, a.hasClass("device-xl") || a.hasClass("device-lg")) {
        ...
        init: function () {
            ...
            return e().isotope ? t.length < 1 ? !0 : t.hasClass("customjs") ? !0 : void t.each(function () {
                var t = e(this), i = t.attr("data-transition"), s = t.attr("data-layout"), n = t.attr("data-stagger"),
                    o = !0;
                i || (i = "0.65s"), s || (s = "masonry"), n || (n = 0), a.hasClass("rtl") && (o = !1), setTimeout(function () {
                    ...
                    }) : t.isotope({layoutMode: s, isOriginLeft: o, transitionDuration: i})
                }, 300)
            }) : (console.log("gridInit: Isotope not Defined."), !0)
        }, filterInit: function () {
            return e().isotope ? H.length < 1 ? !0 : H.hasClass("customjs") ? !0 : void H.each(function () {
                ...
                }), s && (t.find("li").removeClass(i), t.find('[data-filter="' + s + '"]').parent("li").addClass(i), e(a).isotope({filter: s}))
            ...
            e(".portfolio-ajax .portfolio-item a.center-icon").click(function (t) {
                ...
                e(this).parents(".portfolio-item").hasClass("portfolio-active") || SEMICOLON.portfolio.loadItem(a, _), t.preventDefault()
            })
            ...
            if (t > 0) P.find("img").on("load", function () {
                ...
                if (t === a) {
                    ...
                    setTimeout(function () {
                        SEMICOLON.widget.loadFlexSlider(), SEMICOLON.initialize.lightbox(), SEMICOLON.initialize.resizeVideos(), SEMICOLON.widget.masonryThumbs(), e("html,body").stop(!0).animate({scrollTop: P.offset().top - i}, 900, "easeOutQuad")
                    }, 500)
                }
            }); else {
                var i = SEMICOLON.initialize.topScrollOffset();
            ...
            _ = e("#" + t), e("#next-portfolio, #prev-portfolio").click(function () {
                var t = e(this).attr("data-id");
                return j.removeClass("portfolio-active"), e("#" + t).addClass("portfolio-active"), SEMICOLON.portfolio.loadItem(t, _), !1
        ...
        init: function () {
            ...
            return "undefined" != typeof skrollr && e.isFunction(skrollr) ? (console.log("parallax: skrollr not Defined."), !0) : void(($.length > 0 || K.length > 0 || Z.length > 0) && (SEMICOLON.isMobile.any() ? ($.addClass("mobile-parallax"), K.addClass("mobile-parallax"), Z.addClass("mobile-parallax")) : skrollr.init({forceHeight: !1})))
        }, animations: function () {
            ...
            t.length > 0 && t.each(function () {
                var t = e(this), a = t.parent(".fslider").attr("data-animation"),
                    ...
                    n = t.parent(".fslider").attr("data-reverse"), o = t.parent(".fslider").attr("data-slideshow"),
                    r = t.parent(".fslider").attr("data-pause"), l = t.parent(".fslider").attr("data-speed"),
                    d = t.parent(".fslider").attr("data-video"), c = t.parent(".fslider").attr("data-pagi"),
                    u = t.parent(".fslider").attr("data-arrows"), f = t.parent(".fslider").attr("data-thumbs"),
                    h = t.parent(".fslider").attr("data-hover"), m = t.parent(".fslider").attr("data-smooth-height"),
                    p = t.parent(".fslider").attr("data-touch"), g = !1;
                a || (a = "slide"), i && "swing" != i || (i = "swing", g = !0), s || (s = "horizontal"), n = "true" == n ? !0 : !1, o = o ? !1 : !0, r || (r = 5e3), l || (l = 600), d || (d = !1), m = "false" == m ? !1 : !0, "vertical" == s && (m = !1), c = "false" == c ? !1 : !0, c = "true" == f ? "thumbnails" : c, u = "false" == u ? !1 : !0, h = "false" == h ? !1 : !0, p = "false" == p ? !1 : !0, t.flexslider({
            ...
            return t.hasClass("customjs") ? !0 : void(t.length > 0 && t.each(function () {
                var t = e(this), a = t.attr("data-video"), i = t.attr("data-mute"), s = t.attr("data-ratio"),
                    ...
                    u = t.attr("data-start"), f = t.attr("data-stop"), h = t.attr("data-autoplay"),
                    m = t.attr("data-fullscreen");
                i = "false" == i ? !1 : !0, s || (s = "16/9"), n || (n = "hd720"), o || (o = 1), r || (r = "self"), l = "false" == l ? !1 : !0, d = "false" == d ? !1 : !0, c || (c = 1), u || (u = 0), f || (f = 0), h = "false" == h ? !1 : !0, m = "true" == m ? !0 : !1, t.mb_YTPlayer({
                    videoURL: a,
                    mute: i,
                    ratio: s,
                    quality: n,
            ...
            if (e("body").hasClass("device-xs") || e("body").hasClass("device-sm")) e(".tabs.tabs-justify").find(".tab-nav > li").css({width: ""}); else {
            ...
            return t.length < 1 ? !0 : void t.each(function () {
                var t = e(this), a = t.find(".tab-nav"), i = t.find(".tab-container");
                a.children("li").each(function () {
                    var t = e(this), a = t.children("a"), s = a.attr("href"), n = a.html();
                    i.find(s).before('<div class="acctitle d-none"><i class="acc-closed icon-ok-circle"></i><i class="acc-open icon-remove-circle"></i>' + n + "</div>")
                })
            })
            ...
            var t = e(".tabs.tabs-responsive:not(.customjs)");
            return t.length < 1 ? !0 : void t.each(function () {
                var t = e(this), a = t.attr("data-active"), i = t.attr("data-accordion-style");
            ...
            var t = e(".accordion");
            t.length > 0 && t.each(function () {
                var t = e(this), i = t.attr("data-state"), s = t.attr("data-active");
            ...
            t.length > 0 && t.each(function () {
                ...
                i = i ? !0 : !1, a.hasClass("device-xl") || a.hasClass("device-lg") ? t.appear(function () {
            ...
            return t.length < 1 ? !0 : void t.each(function () {
                var t = e(this), i = t.attr("data-items"), s = t.attr("data-items-xl"), n = t.attr("data-items-lg"),
                    o = t.attr("data-items-md"), r = t.attr("data-items-sm"), l = t.attr("data-items-xs"),
                    d = t.attr("data-loop"), c = t.attr("data-autoplay"), u = t.attr("data-speed"),
                    f = t.attr("data-animate-in"), h = t.attr("data-animate-out"), m = t.attr("data-nav"),
                    ...
                    N = t.attr("data-video"), x = t.attr("data-rtl");
                ...
                f || (f = !1), h || (h = !1), m = "false" == m ? !1 : !0, p = "false" == p ? !1 : !0, b = "true" == b ? !0 : !1, C = "true" == C ? !0 : !1, S = "true" == S ? !0 : !1, w = "true" == w ? !0 : !1, N = "true" == N ? !0 : !1, x = "true" == x || a.hasClass("rtl") ? !0 : !1, t.owlCarousel({
                    margin: Number(g),
                    loop: d,
            ...
            var a = e(t), i = a.attr("data-notify-position"), s = a.attr("data-notify-type"),
                n = a.attr("data-notify-msg"), o = a.attr("data-notify-timeout"), r = a.attr("data-notify-close");
            ...
            e("a[data-scrollto]").click(function () {
                ...
                return t.parents("#primary-menu").hasClass("on-click") ? !0 : (i || (i = 750), s || (s = SEMICOLON.initialize.topScrollOffset()), n || (n = "easeOutQuad"), e("html,body").stop(!0).animate({scrollTop: e(a).offset().top - Number(s)}, Number(i), n, function () {
            ...
            return t.length < 1 ? !0 : void t.each(function () {
                var t = e(this), a = t.attr("data-alert-type"), i = t.attr("data-loader"),
                    s = t.find(".widget-subscribe-form-result"), n = t.attr("data-redirect");
                t.find("form").validate({
                    submitHandler: function (t) {
                        if (s.hide(), "button" == i) {
                            var o = e(t).find("button"), r = o.html();
                        ...
                        e(t).ajaxSubmit({
                            target: s, dataType: "json", resetForm: !0, success: function (l) {
            ...
            return t.length < 1 ? !0 : void t.each(function () {
                var t = e(this), a = t.attr("data-alert-type"), i = t.attr("data-loader"),
                    s = t.find(".quick-contact-form-result"), n = t.attr("data-redirect");
                t.find("form").validate({
                    submitHandler: function (t) {
            ...
            return t.length < 1 ? !0 : void t.each(function () {
                var t = e(this), a = t.attr("data-offset-top"), i = t.attr("data-offset-bottom");
            ...
            e().tooltip ? e('[data-toggle="tooltip"]').tooltip({container: "body"}) : console.log("extras: Bootstrap Tooltip not defined."), e().popover ? e("[data-toggle=popover]").popover() : console.log("extras: Bootstrap Popover not defined."), e(".style-msg").on("click", ".close", function (t) {
    ...
    var t = e(window), a = e("body"), i = e("#wrapper"), s = e("#header"), n = e("#header-wrap"), o = e("#content"),
        ...
        f = s.attr("data-responsive-class"), h = e("#logo").find(".standard-logo"),
        m = (h.find("img").outerWidth(), e("#logo").find(".retina-logo")), p = h.find("img").attr("src"),
        g = m.find("img").attr("src"), v = h.attr("data-dark-logo"), C = m.attr("data-dark-logo"),
        O = h.attr("data-sticky-logo"), b = m.attr("data-sticky-logo"), y = h.attr("data-mobile-logo"),
        S = m.attr("data-mobile-logo"), w = e("#page-menu"), N = e(".one-page-menu"), x = 0, I = e(".portfolio"),
        M = (e(".shop"), e(".grid-container")), k = e("#slider"), E = e(".slider-parallax"), L = e(".slider-element"),
        T = "", z = e("#page-title"), j = e(".portfolio-ajax").find(".portfolio-item"), P = e("#portfolio-ajax-wrap"),
        F = e("#portfolio-ajax-container"), D = e("#portfolio-ajax-loader"), H = e(".portfolio-filter,.custom-filter"),
        _ = "", A = e("#top-search"), R = e("#top-cart"), B = e(".vertical-middle"), q = e("#top-social").find("li"),
        Y = e(".si-sticky"), W = e(".dots-menu"), V = e("#gotoTop"), Q = e(".full-screen"), U = e(".common-height"),
        G = e(".testimonials-grid"), J = e(".page-section"), X = e(".owl-carousel"), $ = e(".parallax"),
        K = e(".page-title-parallax"), Z = e(".portfolio-parallax").find(".portfolio-image"), ee = e(".text-rotater"),
